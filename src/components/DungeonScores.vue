...
export default {
  ...
  methods: {
    ...
    keyScores: function (keyLevel) {
      var baseScores = [
        { keyLevel: 2, baseScore: 94, bonus: 0 },
        { keyLevel: 3, baseScore: 99, bonus: 2 },
        { keyLevel: 4, baseScore: 104, bonus: 4 },
        { keyLevel: 5, baseScore: 119, bonus: 6 },
        { keyLevel: 6, baseScore: 124, bonus: 8 },
        { keyLevel: 7, baseScore: 129, bonus: 10 },
        { keyLevel: 8, baseScore: 134, bonus: 12 },
        { keyLevel: 9, baseScore: 139, bonus: 14 },
        { keyLevel: 10, baseScore: 154, bonus: 16 },
        { keyLevel: 11, baseScore: 159, bonus: 18 },
        { keyLevel: 12, baseScore: 164, bonus: 20 },
        { keyLevel: 13, baseScore: 169, bonus: 22 },
        { keyLevel: 14, baseScore: 174, bonus: 24 },
        { keyLevel: 15, baseScore: 179, bonus: 26 },
        { keyLevel: 16, baseScore: 184, bonus: 28 },
        { keyLevel: 17, baseScore: 189, bonus: 30 },
        { keyLevel: 18, baseScore: 194, bonus: 32 },
        { keyLevel: 19, baseScore: 199, bonus: 34 },
        { keyLevel: 20, baseScore: 204, bonus: 36 },
        { keyLevel: 21, baseScore: 209, bonus: 38 },
        { keyLevel: 22, baseScore: 214, bonus: 40 },
        { keyLevel: 23, baseScore: 219, bonus: 42 },
        { keyLevel: 24, baseScore: 224, bonus: 44 },
        { keyLevel: 25, baseScore: 229, bonus: 46 },
