  ...
  methods: {
    ...
    keyScores: function (keyLevel) {
      var baseScores = [
        ...
        { keyLevel: 4, baseScore: 55, bonus: 0 },
        { keyLevel: 5, baseScore: 60, bonus: 0 },
        { keyLevel: 6, baseScore: 65, bonus: 0 },
        { keyLevel: 7, baseScore: 75, bonus: 0 },
        { keyLevel: 8, baseScore: 80, bonus: 0 },
        { keyLevel: 9, baseScore: 85, bonus: 0 },
        { keyLevel: 10, baseScore: 100, bonus: 0 },
        { keyLevel: 11, baseScore: 105, bonus: 2 },
        { keyLevel: 12, baseScore: 110, bonus: 4 },
        { keyLevel: 13, baseScore: 115, bonus: 6 },
